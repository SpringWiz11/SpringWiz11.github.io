...
title: about
permalink: /
subtitle: ML Researcher at <a href='https://workifi.com'>WorkiFi</a> (TIFIN). Bengaluru, India.
...
profile:
  ...
  more_info: >
    <p>Bengaluru, India</p>
    <p>kishangurumurthy [at] gmail [dot] com</p>
...
**Geometric and spectral deep learning.** Graph representation learning, spectral filters, and the homophily/heterophily gap that makes most propagation schemes brittle.

**Continuous-time models.** Neural ODEs and universal differential equations as architectures — depth as integration time, mechanistic priors inside learned vector fields.
...
I'm open to collaborations on geometric deep learning, continuous-time models, and federated graph learning — reach me by email or on [LinkedIn](https://www.linkedin.com/in/kishan-gurumurthy/).
